package com.thanthu.recipeappmongo.bootstrap;
...
import com.thanthu.recipeappmongo.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private List<Recipe> getRecipes() {
		...
		// get UOMs
		UnitOfMeasure eachUom = unitOfMeasureRepository.findByUnit("Each")
				.orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));

		UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findByUnit("Tablespoon")
				.orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));

		UnitOfMeasure teaSpoonUom = unitOfMeasureRepository.findByUnit("Teaspoon")
				.orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));

		UnitOfMeasure dashUom = unitOfMeasureRepository.findByUnit("Dash")
				.orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));

		UnitOfMeasure pintUom = unitOfMeasureRepository.findByUnit("Pint")
				.orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));

		UnitOfMeasure cupsUom = unitOfMeasureRepository.findByUnit("Cup")
				.orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));
